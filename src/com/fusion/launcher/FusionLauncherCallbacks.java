/*
 * Copyright (C) 2019 Fusion Project
 *
...
public class FusionLauncherCallbacks implements LauncherCallbacks,
    ...
    private ClientOptions getClientOptions(SharedPreferences prefs) {
        boolean hasPackage = FusionUtils.hasPackageInstalled(mLauncher, SEARCH_PACKAGE);
